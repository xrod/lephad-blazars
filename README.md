...
If you use the flux predictions or the best-fit parameter values from the leptohadronic model, you may cite the original paper by [Rodrigues et al 2023](https://arxiv.org/abs/2307.13024).
